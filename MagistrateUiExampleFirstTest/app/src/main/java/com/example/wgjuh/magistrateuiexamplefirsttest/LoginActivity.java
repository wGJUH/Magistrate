...
public class LoginActivity extends AppCompatActivity implements OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // populateAutoComplete();
        ...
        /*
            Подключаем EditorActionListner  к полю ввода пароля, в Xml поля пароля прописываем id Action
             и action label, этот лэйбл заменит кнопку enter на клавиатуре ввода.
             Теперь при нажатии на эту кнопку вызовется метод логирования.
         */
        ...
        /*
            При нажатии будет вызван метод логирования в приложение.
         */
  ...
  /*  private void populateAutoComplete() {
   ...
   /* @Override
    ...
    private void attemptLogin() {
        /**
         * Если уже есть запущенная процедура авторизации, то завершаем метод.
         */
        if (mAuthTask != null) {
            return;
        }
        ...
        /**
         * Обнуляем ошибки полей логина и пароля.
         */
        // Reset errors.
        ...
        /**
         * Получаем текстовые значения полей логина и пароля
         */
        ...
        /**
         * Вью в котороем в данный момент ошибка
         */
        View focusView = null;

        // Check for a valid password, if the user entered one.
        /**
         * Если поле пароля не пустое, то проверяем валидный ли пароль.
         */
        if (!TextUtils.isEmpty(password) && !isPasswordValid(password)) {
            /**
             * Устанавливаем текст ошибки и ставим в качестве фокусированого поле ввода пароля.
             */
        ...
        if (TextUtils.isEmpty(email)) {
            ...
            cancel = true;
        } else /** Если пароль введен проверяем его на валидность.*/if (!isEmailValid(email)) {
    ...
    /**
     * Метод отвечающий за проверку адреса электронной почты на валидность
     ...
     * Показываем интерфейс ожидания и закрываем форму логина.
     */
    ...
    private void showProgress(final boolean show) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB_MR2) {
            ...
            /**
             * Если получили в качестве параметра true то прячем форму логирования
             */
